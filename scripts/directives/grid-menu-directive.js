define(['app'],
    function (app) {
        app.directive('gridMenu', ['genericGridCommonService', 'genericGridSettingService', '$rootScope',
            function (genericGridCommonService, genericGridSettingService, $rootScope) {
                'use strict';
